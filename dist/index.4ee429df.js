...
},{"./menu.js":"3Uxhu","./tab.js":"4J9zY","./accordeon.js":"5XvBW","./input.js":"44Z7c","./gsap.js":"21h0m"}],"3Uxhu":[function(require,module,exports) {
"use strict";
...
function tabComponent(tabBtnWrapperSelector, tabBtnsSelector, tabItemsSelector, btnActiveClass, tabActiveClass) {
  var tabBtnsWrapper = document.querySelector(tabBtnWrapperSelector);
  var tabBtns = document.querySelectorAll(tabBtnsSelector);
  var tabItems = document.querySelectorAll(tabItemsSelector);
  ...
  function clearState(btns, items) {
    ...
    btns.forEach(function (btn) {
      return btn.classList.remove(btnActiveClass);
    });
    items.forEach(function (item) {
      return item.classList.remove(tabActiveClass);
    });
  }
  function turnOnActive(btns, tabs, i, wrapper) {
    ...
    var children = Array.from(tabs[i].children);
    children.length > 0 && children.forEach(function (el, i) {
      console.log('el: ', el);
...
tabComponent('.tab__buttons', '.tab__btn', '.content-tab__item', 'tab__btn_active', 'content-tab__item_active');

},{"core-js/stable":"1PFvP"}],"1PFvP":[function(require,module,exports) {
...
},{"../internals/export":"7f5VM"}],"5XvBW":[function(require,module,exports) {
"use strict";
require("core-js/stable");
function accordeonComponent(btnsSelector, itemsSelector, activeClass1, activeClass2) {
  var accordeonBtns = document.querySelectorAll(btnsSelector);
  var tabItems = document.querySelectorAll(itemsSelector);
  console.log('accordeonBtns: ', accordeonBtns);
  console.log('tabItems: ', tabItems);
  accordeonBtns.forEach(function (btn, i) {
...
accordeonComponent('.accordeon__header', '.accordeon__item', 'accordeon__item_active', 'open');

},{"core-js/stable":"1PFvP"}],"44Z7c":[function(require,module,exports) {
"use strict";
...
},{}],"21h0m":[function(require,module,exports) {
"use strict";
require("core-js/stable");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabActiveItem = document.getElementsByClassName('content-tab__item_active');
  console.log('tabActiveItem: ', tabActiveItem);
});

},{"core-js/stable":"1PFvP"}]},["3AS1F","SXDIM"], "SXDIM", "parcelRequire6daa")
